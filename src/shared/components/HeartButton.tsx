...
export default function HeartButton({ postingId, isSaved }: HeartButtonProps) {
  ...
  return (
    <button
      onClick={handleClick}
      disabled={isPending}
      className={`flex items-center justify-center p-1.5 rounded-full transition-all duration-300 hover:bg-slate-50 cursor-pointer active:scale-75 disabled:opacity-50`}
