...
import { getNotifications, markAsRead } from '@/apis/notification';
    ...
    return (
      ...
      >
        <div className="w-full max-w-[402px] mx-auto bg-white flex flex-col">
          {[1, 2, 3].map((i) => (
            <div key={i} className="h-[106px] flex flex-col justify-center px-[20px] py-[28px] border-b border-gray-100 animate-pulse">
      ...
      <div className="w-full max-w-[402px] mx-auto bg-white flex flex-col">
        {notifications && notifications.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-gray-400">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className="size-12 mb-4 text-gray-300" strokeWidth="1.5">
              <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a9.001 9.001 0 0 1-11.963-9.4A8.961 8.961 0 0 1 12 3c1.252 0 2.455.256 3.548.709m-1.745 12.012a9 9 0 0 1 0-14.544M12 21H12.008M12 18H12.008" />
            </svg>
